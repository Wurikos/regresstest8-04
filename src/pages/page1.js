...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"page1"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Section text-align="center" padding="100px 0" sm-padding="40px 0">
			...
			<Components.Page322 background="#205796" />
			<Components.Page322 />
		</Section>
		<Components.Tecomponent2040 />
		<Link
			font={"--capture"}
			font-size={"10px"}
			position={"fixed"}
		...
		<RawHtml>
			<script place={"endOfHead"} rawKey={"606ebe37ed0212414ce08aac"}>
				{"alert(\"работает\")"}
			</script>
		</RawHtml>
	</Theme>;
